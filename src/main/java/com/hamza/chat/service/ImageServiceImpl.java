...
public class ImageServiceImpl implements ImageService {
	 ...
	 @Autowired
	 ChatService produitService;
	 
	 @Autowired
	 ChatRepository produitRepository;
		...
		@Override
		public Image uplaodImageChat(MultipartFile file,Long idChat) 
		throws IOException {
				Chat c = new Chat();
				c.setIdChat(idChat);
		...
		@Override
		public List<Image> getImagesParChat(Long chatId) {
			Chat c = produitRepository.findById(chatId).get();
				return c.getImages();
		}
